...
Une version avancée de la plateforme est en cours de développement dans les dossiers `client` et `server`. Elle s'appuie sur React, Node.js et PostgreSQL. Un premier composant React affiche désormais un échiquier interactif respectant les règles de base. Les instructions de lancement se trouvent dans `docs/chess-platform/README.md`.
